...
pub struct Metrics {
    ...
    pub gossip_recv: u64,
    /// Application-state gossip messages sent.
    pub app_gossip_sent: u64,
    /// Application-state gossip messages received.
    pub app_gossip_recv: u64,
...
impl Metrics {
    ...
    pub fn prometheus(&self, alive: usize, suspect: usize, dead: usize) -> String {
        ...
        counter!("swim_app_gossip_sent_total", "Application gossip messages sent.", self.app_gossip_sent);
        counter!("swim_app_gossip_recv_total", "Application gossip messages received.", self.app_gossip_recv);
    ...
    pub fn json(&self, alive: usize, suspect: usize, dead: usize) -> String {
        format!(
            r#"{{"gossip_rounds":{},"gossip_sent":{},"gossip_recv":{},"app_gossip_sent":{},"app_gossip_recv":{},"pings_sent":{},"pings_recv":{},"acks_sent":{},"acks_recv":{},"ping_reqs_sent":{},"ping_reqs_recv":{},"probe_direct_timeouts":{},"probe_failures":{},"merges_new":{},"merges_updated":{},"merges_stale":{},"anti_entropy_sent":{},"rate_limited":{},"reliable_retries":{},"reliable_exhausted":{},"alive":{},"suspect":{},"dead":{}}}"#,
            self.gossip_rounds, self.gossip_sent, self.gossip_recv,
            self.app_gossip_sent, self.app_gossip_recv,
    ...
    pub fn summary(&self, alive: usize, suspect: usize, dead: usize) -> String {
        format!(
            "gossip_rounds={} gossip_sent={} gossip_recv={} app_gossip_sent={} app_gossip_recv={} \
            ...
            self.gossip_sent,
            self.gossip_recv,
            self.app_gossip_sent,
            self.app_gossip_recv,
            self.pings_sent,
            self.pings_recv,
            self.acks_sent,
            self.acks_recv,
...
mod tests {
    ...
    fn summary_format() {
        ...
        assert!(s.contains("app_gossip_sent=4"));
    ...
    fn prometheus_format_contains_all_metrics() {
        ...
        assert!(p.contains("swim_app_gossip_sent_total 2"));
        assert!(p.contains("swim_app_gossip_recv_total 3"));
    ...
    fn json_format_valid() {
        ...
        assert!(j.contains(r#""app_gossip_recv":9"#));
